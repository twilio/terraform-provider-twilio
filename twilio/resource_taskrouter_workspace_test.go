		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckGithubOrganizationWebhookExists(rn, &workspace),
					testAccCheckGithubOrganizationWebhookAttributes(&workspace, &testAccGithubOrganizationWebhookExpectedAttributes{
