...
**messages_count** | string | *Computed* | The number of Messages in the Channel
...
**joined_channels_count** | string | *Computed* | The number of Channels this User is a Member of
