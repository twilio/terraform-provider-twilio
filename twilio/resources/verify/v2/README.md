...
**date_created** | string | *Computed* | The date this Entity was created
**date_updated** | string | *Computed* | The date this Entity was updated
**links** | string | *Computed* | Nested resource URLs.
**sid** | string | *Computed* | A string that uniquely identifies this Entity.
**url** | string | *Computed* | The URL of this resource.
...
**account_sid** | string | *Computed* | Account Sid.
**binding** | string | *Computed* | Unique external identifier of the Entity
**config** | string | *Computed* | Binding for a &#x60;factor_type&#x60;.
**date_created** | string | *Computed* | The date this Factor was created
**date_updated** | string | *Computed* | The date this Factor was updated
**entity_sid** | string | *Computed* | Entity Sid.
**status** | string | *Computed* | The Status of this Factor
**url** | string | *Computed* | The URL of this resource.
